...
public sealed class UpdateStockLocationTransferValidator : AbstractValidator<UpdateStockLocationTransferCommand>
{
    public UpdateStockLocationTransferValidator()
    {
