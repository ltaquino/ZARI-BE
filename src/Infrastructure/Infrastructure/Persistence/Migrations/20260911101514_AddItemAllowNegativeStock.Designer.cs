...
namespace ZARI.Infrastructure.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260911101514_AddItemAllowNegativeStock")]
    partial class AddItemAllowNegativeStock
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZARI.Domain.Entities.CustomerPaymentTender", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("BankOrPartnerName")
                        .HasMaxLength(150)
                        .HasColumnType("varchar(150)");
                    ...
                    b.ToTable("CustomerPaymentTenders");
                });
            ...
            modelBuilder.Entity("ZARI.Domain.Entities.DiscountRuleItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("DiscountRuleId", "ItemId")
                        .IsUnique();

                    b.ToTable("DiscountRuleItems");
                });
            ...
            modelBuilder.Entity("ZARI.Domain.Entities.PaymentMethod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("ReferenceNoLabel")
                        .HasMaxLength(150)
                        .HasColumnType("varchar(150)");

                    b.Property<bool>("RequiresBankOrPartnerName")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("RequiresReferenceNo")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("ZARI.Domain.Entities.PosPromoSlide", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("PosPromoSlides");
                });

            modelBuilder.Entity("ZARI.Domain.Entities.PosTerminal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ZARI.Domain.Entities.ReportTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("ZARI.Domain.Entities.DiscountRuleItem", b =>
                {
                    b.HasOne("ZARI.Domain.Entities.DiscountRule", "DiscountRule")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("ZARI.Domain.Entities.SalesInvoice", b =>
                {
                    ...
                    b.HasOne("ZARI.Domain.Entities.PosTerminal", "PosTerminal")
                        .WithMany()
